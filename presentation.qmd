...
-   For our analysis some of the most important variables will be:
    ...
    **`population`**
    ...
    ::: {.column width="33%" style=".panel-content {     width: 100%;     height: 500px"}
    **`totalvotes`**
    :::
...
What percentage of House members get re-elected throughout the years and what types of voting play significant roles in these elections?
