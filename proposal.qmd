...
2)  **Visualization**:
Calculating  the correlation coefficients between the election outcomes  and each demographic factor like population, income, voter, education, race/ethnicity distributions and analyzing the heatmap, we can identify which demographic factors have the strongest correlation with election outcomes and understand how they influence political dynamics.
